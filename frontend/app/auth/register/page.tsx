        ...
        <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-black font-sans text-white">
            ...
            <div className="w-full max-w-md p-8">
                <div className="mb-8 text-center">
                    ...
                    <h1 className="text-3xl font-semibold tracking-tight text-white">Kayıt Ol</h1>
                    <p className="mt-2 text-sm text-zinc-400">
                        Finansal özgürlüğün için ilk adımı at.
                    </p>
                </div>
                ...
                <div className="group relative rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8 backdrop-blur-xl transition-all hover:border-zinc-700">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            className="inline-flex h-12 w-full items-center justify-center rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 px-8 text-sm font-medium text-white transition-all hover:opacity-90 active:scale-95 disabled:pointer-events-none disabled:opacity-50 mt-2"
                            type="submit"
                            disabled={isLoading}
                        >
                            {isLoading ? (
                    ...
                    <div className="mt-6 text-center text-sm">
                        ...
                        <Link href="/auth/login" className="font-medium text-white hover:text-purple-400 transition-colors">
                            Giriş Yap
                        </Link>
                    </div>
                </div>
